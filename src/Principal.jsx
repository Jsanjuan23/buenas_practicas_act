    ...
    <body style={{ fontFamily: 'Arial, sans-serif', backgroundColor: '#f5f5f5', margin: '0', padding: '0', boxSizing: 'border-box' }}>
      <div>
        <header style={{ backgroundColor: '#333', color: '#fff', textAlign: 'center', padding: '2em', fontFamily: 'Helvetica, Arial, sans-serif' }}>
          <h1 style={{ margin: '0', fontSize: '2.5em', fontWeight: 'bold' }}>Mi Perfil</h1>
        </header>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', padding: '20px', backgroundColor: '#fff' }}>
          <div style={{ width: '600px', padding: '15px', borderRadius: '8px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }}>
            <h2 style={{ margin: '0 0 10px', fontSize: '2em', fontWeight: 'bold', borderBottom: '2px solid #333', paddingBottom: '10px' }}>Información Personal</h2>
            <p style={{ margin: '0 0 10px', fontSize: '1.2em', fontStyle: 'italic' }}>Nombre Completo: Jesus Sanjuan</p>
            <p style={{ margin: '0 0 10px', fontSize: '1.2em', fontStyle: 'italic' }}>Semestre que Curso: Décimo Semestre</p>

            <h2 style={{ margin: '20px 0 10px', fontSize: '2em', fontWeight: 'bold', borderBottom: '2px solid #333', paddingBottom: '10px' }}>Hobbies</h2>
            <p style={{ margin: '0 0 20px', fontSize: '1.2em', fontStyle: 'italic' }}>Mis Hobbies: Viajar, Leer, Jugar a videojuegos</p>

            <h2 style={{ margin: '20px 0 10px', fontSize: '2em', fontWeight: 'bold', borderBottom: '2px solid #333', paddingBottom: '10px' }}>Series Favoritas</h2>
            <div>
              <h3 style={{ margin: '0 0 10px', fontSize: '1.5em', fontWeight: 'bold' }}>Breaking Bad</h3>
              <p style={{ margin: '0 0 10px', fontSize: '1.2em', fontStyle: 'italic' }}>
              ...
              <p style={{ margin: '0 0 10px', fontSize: '1.2em', fontStyle: 'italic' }}>Actores Relevantes: Bryan Cranston, Aaron Paul</p>
              <img
            ...
            <div>
              <h3 style={{ margin: '20px 0 10px', fontSize: '1.5em', fontWeight: 'bold' }}>Stranger Things</h3>
              <p style={{ margin: '0 0 10px', fontSize: '1.2em', fontStyle: 'italic' }}>
              ...
              <p style={{ margin: '0 0 10px', fontSize: '1.2em', fontStyle: 'italic' }}>Actores Relevantes: Millie Bobby Brown, Finn Wolfhard</p>
              <img
            ...
            <div>
              <h3 style={{ margin: '20px 0 10px', fontSize: '1.5em', fontWeight: 'bold' }}>The Mandalorian</h3>
              <p style={{ margin: '0 0 10px', fontSize: '1.2em', fontStyle: 'italic' }}>
              ...
              <p style={{ margin: '0 0 10px', fontSize: '1.2em', fontStyle: 'italic' }}>Actor Principal: Pedro Pascal</p>
              <img
